...
class AboutPage(QWidget):
    ...
    def __init__(self):
        ...
        self.add_paragraph("Welcome to DoS, an educational application designed to teach users about Denial of Service attacks. DoS is created with the goal of raising awareness about the potential risks and vulnerabilities associated with DoS attacks and empowering users to protect themselves and their applications against such threats.", inner_layout)

        self.add_heading("Our Mission", inner_layout, font_size=30, alignment=Qt.AlignmentFlag.AlignCenter)
        self.add_paragraph("""
            At DoS, our mission is to educate individuals and organizations about DOS attacks and provide them with the knowledge and tools necessary to prevent and mitigate these threats. We believe that by understanding how DOS attacks work and adopting best practices for web security, users can safeguard their data and protect against potential exploitation.
        """, inner_layout)
