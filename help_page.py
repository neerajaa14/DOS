...
class HelpPage(QWidget):
    ...
    def __init__(self):
        ...
        self.add_paragraph("""
            This section is where you will be learning the concepts of DOS and how to implement them. It is recommended that you go through this section before attending the <span>Levels</span> Section.
        """, inner_layout)
        ...
        self.add_paragraph("""
            For more details or queries, contact dos@gmaill.com
        """, inner_layout)
